...
# 学習
if "w" in args[3]:
    model_steppable_region = cnn_models.cnn_steppable((35,35,1), "../checkpoints/checkpoint")
else:
    model_steppable_region = cnn_models.cnn_steppable((35,35,1), "")
if "v" in args[3]:
